use crate::config::TokenSourceConfig;
...
mod tests {
    ...
    #[test]
    fn extract_from_custom_header() {
        let mut headers = HeaderMap::new();
        headers.insert("x-api-key", HeaderValue::from_static("api_key_value"));
        ...
        assert_eq!(token.as_deref(), Some("api_key_value"));
    }
